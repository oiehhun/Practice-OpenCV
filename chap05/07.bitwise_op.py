...
image3 = cv2.bitwise_or(image1, image2)				# 비트 OR 연산(원소 간 논리합)
image4 = cv2.bitwise_and(image1, image2)			# 비트 AND 연산(원소 간 논리곱)
image5 = cv2.bitwise_xor(image1, image2)			# 비트 XOR 연산(원소 간 배타적 논리합)
image6 = cv2.bitwise_not(image1)						# 비트 NOT 연산(원소 간 반전)
